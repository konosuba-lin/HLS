...
# ==============================================================
set ::env(PATH) "$::env(PATH);Z:/Xilinx/Vitis_HLS/2022.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);Z:/Xilinx/Vitis_HLS/2022.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);Z:/Xilinx/Vitis_HLS/2022.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);Z:/Xilinx/Vitis_HLS/2022.1/win64/tools/dds_v6_0"
set ::env(PATH) "$::env(PATH);Z:/Xilinx/Vitis_HLS/2022.1/win64/csim"
### C sim ###
