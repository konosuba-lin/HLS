...
(* CORE_GENERATION_INFO="adders_io_adders_io,hls_ip_2022_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgb2104-1-e,HLS_INPUT_CLOCK=2.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=0.907000,HLS_SYN_LAT=2,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=69,HLS_SYN_LUT=180,HLS_VERSION=2022_1}" *)
...
always @ (*) begin
    if (((ap_start == 1'b0) | (in2_ap_vld_in_sig == 1'b0) | (in1_ap_vld_in_sig == 1'b0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((ap_start == 1'b0) | (in2_ap_vld_in_sig == 1'b0) | (in1_ap_vld_in_sig == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln53_fu_55_p2 = (in2_in_sig + in1_in_sig);
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (in2_ap_vld_in_sig == 1'b0) | (in1_ap_vld_in_sig == 1'b0));
end
...
assign in_out1_o_int_regslice = (add_ln53_fu_55_p2 + in_out1_i_int_regslice);
