# 1 "../course-labA/Interface_Synthesis/lab2/adders_io.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 359 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../course-labA/Interface_Synthesis/lab2/adders_io.c" 2
# 46 "../course-labA/Interface_Synthesis/lab2/adders_io.c"
# 1 "../course-labA/Interface_Synthesis/lab2/adders_io.h" 1
# 49 "../course-labA/Interface_Synthesis/lab2/adders_io.h"
__attribute__((sdx_kernel("adders_io", 0))) void adders_io(int in1, int in2, int *in_out1);
# 47 "../course-labA/Interface_Synthesis/lab2/adders_io.c" 2

__attribute__((sdx_kernel("adders_io", 0))) void adders_io(int in1, int in2, int *in_out1) {
#line 15 "C:/Users/user/Desktop/HLS/labA_vitis/labA-2/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=adders_io
# 48 "../course-labA/Interface_Synthesis/lab2/adders_io.c"
