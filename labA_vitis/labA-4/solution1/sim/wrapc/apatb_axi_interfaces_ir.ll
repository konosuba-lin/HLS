...
define void @apatb_axi_interfaces_ir(i16* noalias nocapture nonnull "fpga.decayed.dim.hint"="32" %d_o, i16* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="32" %d_i) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_axi_interfaces_hw(i16* %2, i16* %3)
...
declare void @apatb_axi_interfaces_hw(i16*, i16*)
...
define void @axi_interfaces_hw_stub_wrapper(i16*, i16*) #4 {
entry:
  ...
  call void @axi_interfaces_hw_stub(i16* %4, i16* %5)
