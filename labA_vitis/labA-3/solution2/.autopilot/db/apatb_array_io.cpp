...
extern "C" void array_io_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
tr.import<2>((char*)__xlx_apatb_param_d_i_0, 8, 0);
  }
aesl_fh.write(AUTOTB_TVIN_d_i_0, tr.p, tr.tbytes);
}

  tcl_file.set_num(8, &tcl_file.d_i_0_depth);
#else
...
tr.import<2>((char*)__xlx_apatb_param_d_i_1, 8, 0);
  }
aesl_fh.write(AUTOTB_TVIN_d_i_1, tr.p, tr.tbytes);
}

  tcl_file.set_num(8, &tcl_file.d_i_1_depth);
#else
...
#endif
unsigned __xlx_offset_byte_param_d_i_2 = 0;
#ifdef USE_BINARY_TV_FILE
{
aesl_fh.touch(AUTOTB_TVIN_d_i_2, 'b');
transaction<16> tr(8);
  __xlx_offset_byte_param_d_i_2 = 0*2;
  if (__xlx_apatb_param_d_i_2) {
tr.import<2>((char*)__xlx_apatb_param_d_i_2, 8, 0);
  }
aesl_fh.write(AUTOTB_TVIN_d_i_2, tr.p, tr.tbytes);
}

  tcl_file.set_num(8, &tcl_file.d_i_2_depth);
#else
...
if (__xlx_apatb_param_d_i_2) {
for (size_t i = 0; i < 8; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_d_i_2 + i * 2;
std::string s = formatData(pos, 16);
aesl_fh.write(AUTOTB_TVIN_d_i_2, s);
}
}
}
...
#endif
unsigned __xlx_offset_byte_param_d_i_3 = 0;
#ifdef USE_BINARY_TV_FILE
{
aesl_fh.touch(AUTOTB_TVIN_d_i_3, 'b');
transaction<16> tr(8);
  __xlx_offset_byte_param_d_i_3 = 0*2;
  if (__xlx_apatb_param_d_i_3) {
tr.import<2>((char*)__xlx_apatb_param_d_i_3, 8, 0);
  }
aesl_fh.write(AUTOTB_TVIN_d_i_3, tr.p, tr.tbytes);
}

  tcl_file.set_num(8, &tcl_file.d_i_3_depth);
#else
...
if (__xlx_apatb_param_d_i_3) {
for (size_t i = 0; i < 8; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_d_i_3 + i * 2;
std::string s = formatData(pos, 16);
aesl_fh.write(AUTOTB_TVIN_d_i_3, s);
}
}
}
...
array_io_hw_stub_wrapper(__xlx_apatb_param_d_o_0, __xlx_apatb_param_d_o_1, __xlx_apatb_param_d_o_2, __xlx_apatb_param_d_o_3, __xlx_apatb_param_d_i_0, __xlx_apatb_param_d_i_1, __xlx_apatb_param_d_i_2, __xlx_apatb_param_d_i_3);
