...
tr.send<2>((char*)__xlx_apatb_param_d_o_0, 16);
}
#else
{
...
if (little_endian()) { tr.reorder(); }
tr.send<2>((char*)__xlx_apatb_param_d_o_1, 16);
}
#else
{
      static ifstream rtl_tv_out_file;
...
tr.import<2>((char*)__xlx_apatb_param_d_o_0, 16, 0);
  }
...
tr.import<2>((char*)__xlx_apatb_param_d_o_1, 16, 0);
  }
